...
async function salvarProduto() {
    ...
    document.querySelectorAll('#listaGradePacotes > div').forEach(d => {
        pacotes.push({ qtd: parseInt(d.querySelector('.q').value), preco: parseFloat(d.querySelector('.p').value) });
    });

    let progressivo = [];
    document.querySelectorAll('#listaGradeProgressivo > div').forEach(d => {
        progressivo.push({ q: parseInt(d.querySelector('.q').value), p: parseFloat(d.querySelector('.p').value) });
    });
